package {
	...
	public class ForagingDist extends MovieClip {
		...
		//public var startFuel:Number = 10;
		...
		*/
		...
		public function ForagingDist() {
			...
			starField.graphics.drawRect(0, 0, (VIEW_XWINDOW), (VIEW_YWINDOW));
...
*/
		...
		protected function hiScoresClickHandler(event:KeyboardEvent):void
		{
			switch( event.keyCode )
			{
				case Keyboard.SPACE:
					stage.removeEventListener(KeyboardEvent.KEY_DOWN, hiScoresClickHandler);
					removeChild(instructField);
		...
		protected function onCompleteHandler(event:Event):void
		{
			...
			stage.addEventListener(KeyboardEvent.KEY_DOWN, hiScoresClickHandler);
		}
